      ...
      {applied ? (
        <div className="space-y-2.5">
          ...
          <button
            ...
            onClick={onRefine}
            className="w-full rounded-xl border border-line/15 py-2.5 text-sm font-medium text-fg transition hover:bg-line/5 active:scale-[0.97] motion-reduce:active:scale-100"
          >
            Make another change
          </button>
          {historyControls && (
            <div className="flex items-center gap-1.5 pt-0.5">
              ...
              <GhostBtn
                ...
                label="Redo"
              />
              <div className="h-3.5 w-px bg-line/10" />
              <GhostBtn
